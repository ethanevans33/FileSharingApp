...
CREATE TABLE users (
    ...
    public_key TEXT,             -- Stores the user's public key
...
CREATE TABLE files (
    ...
    encrypted_aes_key BYTEA NOT NULL,  -- Stores encrypted AES key
    encrypted_file BYTEA NOT NULL,     -- Stores the actual encrypted file content
